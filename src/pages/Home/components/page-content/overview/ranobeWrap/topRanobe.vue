<template>
    <div class="info-box">
        ...
        <div class="browse-more" v-if="isExpanded">
            <router-link @mousedown="$emit('set-tab', 4)" to="/browse" class="button-more browse open-browse"><p>BROWSE MORE</P><i class="fas fa-angle-right"></i></router-link>
        </div>
    </div>
</template>
